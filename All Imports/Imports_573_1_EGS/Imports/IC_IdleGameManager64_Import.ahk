...
this.game.gameInstances.Controller.userData.ActiveUserGameInstance := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Int", [0x2ac])
...
this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs.inventoryAmount := New GameObjectStructure(this.game.gameInstances.Controller.userData.BuffHandler.inventoryBuffs,"Int", [0xd4])
...
this.game.gameInstances.BuffHandler.activeBuffs.RemainingTime := New GameObjectStructure(this.game.gameInstances.BuffHandler.activeBuffs,"Float", [0xc8])
...
this.game.gameInstances.BuffHandler.activeBuffs.TotalDuration := New GameObjectStructure(this.game.gameInstances.BuffHandler.activeBuffs,"Int", [0xc4])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.def.SeatID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.def,"Int", [0x1d0])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.Benched := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"Char", [0x354])
...
this.game.screenController.activeScreen.currentScreenWidth := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x35c])
this.game.screenController.activeScreen.currentScreenHeight := New GameObjectStructure(this.game.screenController.activeScreen,"Int", [0x360])
...
this.game.gameInstances.Controller.userData.inited := New GameObjectStructure(this.game.gameInstances.Controller.userData,"Char", [0x298])
...
this.game.gameInstances.OfflineHandler.OfflineTimeRequested_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xec])
this.game.gameInstances.OfflineHandler.OfflineTimeSimulated_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xf0])
this.game.gameInstances.OfflineHandler.CurrentStopReason_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xfc])
this.game.gameInstances.OfflineHandler.CurrentState_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0xe0])
this.game.gameInstances.Screen := New GameObjectStructure(this.game.gameInstances,"Int", [0x10])
this.game.gameInstances.Screen.uiController := New GameObjectStructure(this.game.gameInstances.Screen,"Int", [0x3c8])
...
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar,"Int", [0x360])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox,"Int", [0x3a0])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar,"Int", [0x368])
this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton.toggled := New GameObjectStructure(this.game.gameInstances.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButton,"Char", [0x3d2])
...
this.game.gameInstances.Screen.uiController.bottomBar.levelUpAmount := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x440])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x388])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"HashSet", [0x3b8])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.nextUpgrade := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x408])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes.hero := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.activeBoxes,"Int", [0x3d0])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"Dict", [0x3c0])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat.nextUpgrade := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat,"Int", [0x408])
...
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat.maxLevelUpAllowed := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat,"Int", [0x430])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat.levelUpButtonDisplay := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat,"Int", [0x3a0])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat.levelUpButtonDisplay.lastCostText := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.heroBoxsBySeat.levelUpButtonDisplay,"UTF-16", [0x380])
this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar,"Int", [0x3b0])
this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.formationButtons := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu,"List", [0x340])
...
this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.clearButton := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu,"Int", [0x378])
this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.clearButton._x := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.clearButton,"Float", [0x274])
this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.clearButton._y := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.formationSaveMenu.clearButton,"Float", [0x278])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel,"Int", [0x3b0])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox.maxLevelUpAllowed := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox,"Int", [0x3cc])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox.levelUpButtonDisplay := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox,"Int", [0x340])
this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox.levelUpButtonDisplay.lastCostText := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bottomBar.heroPanel.clickDamageBox.levelUpButtonDisplay,"UTF-16", [0x380])
...
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar,"List", [0x3a0])
...
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems.hero := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems,"Int", [0x398])
...
this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems.ultimateAttack := New GameObjectStructure(this.game.gameInstances.Screen.uiController.ultimatesBar.ultimateItems,"Int", [0x3a0])
...
this.game.gameInstances.Screen.uiController.bossPowerupPopup.highestPowerup := New GameObjectStructure(this.game.gameInstances.Screen.uiController.bossPowerupPopup,"Double", [0x388])
...
this.game.gameInstances.Screen.uiController.notificationManager.notificationDisplay.welcomeBackNotification := New GameObjectStructure(this.game.gameInstances.Screen.uiController.notificationManager.notificationDisplay,"Int", [0x350])
this.game.gameInstances.Screen.uiController.notificationManager.notificationDisplay.welcomeBackNotification.Active := New GameObjectStructure(this.game.gameInstances.Screen.uiController.notificationManager.notificationDisplay.welcomeBackNotification,"Char", [0x489])
